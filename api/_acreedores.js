...
// 🔑 La lectura del dashboard se mudó a `lib/` porque la necesita también `_compromisos.js`, que
// antes de anotar un compromiso tiene que saber cuánto se le debe de verdad al acreedor. Copiarla
// era el mismo error que este circuito ya pagó dos veces esta semana.
...
export default async function handler(req, res) {
  ...
  const r = await leerAcreedoresDelDashboard();
