...
/** Los 22 campos de DatosETL. Se comparan de a uno: un toEqual del objeto entero dice "algo cambió" y nada más. */
const CAMPOS: (keyof DatosETL)[] = [
  'ventas', 'detalles', 'invByProduct', 'invByProdModelo', 'invDepoMin', 'prodMeta',
  'fmKeyPids', 'fmProdCreatedAt', 'allVvar', 'allProductos', 'allVariantes', 'allMonths',
