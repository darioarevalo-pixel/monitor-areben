...
function prod(over: Partial<Producto> & { id: string }): Producto {
  return {
    ...
    phase: { label: 'madurez', cls: 'badge-info' }, ventasMin: { total: 0, s7: 0, s15: 0, s30: 0, s90: 0, first: null, last: null }, ventasMay: { total: 0, s7: 0, s15: 0, s30: 0, s90: 0, first: null, last: null }, minOnline: 0, minLocal: 0, ...over,
  }
}
