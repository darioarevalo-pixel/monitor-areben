...
/**
 * Los cupones del mostrador: un descuento nominal por cliente que la empleada busca por nombre al
 * cobrar. **No toca la tienda online.**
 *
 * Era `Cupones.tsx`; se mudó acá cuando la sección pasó a tener dos pestañas (`Cupones.tsx` es
 * ahora el shell). El comportamiento no cambió en nada.
 */
