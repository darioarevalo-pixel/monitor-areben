...
import { color, space, font, weight } from '@/components/ui/tokens'
...
export const Card = forwardRef<HTMLDivElement, CardProps>(function Card({ padding = 6, interactive, className, style, ...rest }, ref) {
  return (
    <div
      ref={ref}
      className={['mo-card', interactive ? 'mo-card--interactive' : '', className ?? ''].filter(Boolean).join(' ')}
