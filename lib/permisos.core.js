...
export const SECCION_AREA = {
  ...
  'novedades': 'sistema',
  'manuales': 'sistema',
  // Igual que las dos de arriba: área propia, nadie la hereda por función y no hace falta, porque
...
export const ACCESO_POR_FUNCION = {
  ...
  marketing: { areas: ['marketing', 'meta'], keys: ['solicitudes'] },
  local: { areas: ['local'] },
 ...
 *
 * ⚠️ Los gates que ya existían (`api/_liquidacion.js`, `api/_calendario.js`, `api/_agenda.js`)
 * llaman a `puedeVer` derecho, así que ahí la cuenta fija NO se está aplicando. No se toca en el
 * mismo commit que esto: son secciones en uso y cambiarles el alcance sin avisar es sacarle la
 * pantalla a alguien de un día para el otro.
 */
