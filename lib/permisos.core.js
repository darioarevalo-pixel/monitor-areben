...
export const SECCION_AREA = {
  ...
  'novedades': 'sistema',
  'manuales': 'sistema',
  // Lo mismo: área propia, nadie la hereda por función, y está en KEYS_PARA_TODOS. Lo que se tilda
  // a mano es el sub `organizacion.editar` — el reparto lo ve todo el equipo y lo cambia quien manda.
 ...
 */
export const KEYS_PARA_TODOS = new Set(['inicio', 'novedades', 'manuales', 'agenda', 'organizacion'])
