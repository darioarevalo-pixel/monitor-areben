 ...
 *           forma: string|null, retornoDecidido: boolean }} o
 */
export function registroDeRetencion(o) {
  const { motivo, escenario, respuesta, monto, forma, retornoDecidido } = o;
  ...
  return { campos: { retencion_respuesta: respuesta, retencion_monto: Number(monto), retencion_forma: forma } };
}
