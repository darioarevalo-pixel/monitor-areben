...
export const PERFIL_MOTIVO = {
  ...
  excedente: {
    ayuda: 'Le llegó un producto DE MÁS, que no compró. Es el único caso que toca dos ventas: se señala de qué otra venta salió, y esa otra la abre una persona.',
...
export const CASOS = {
  ...
  excedente: {
    ...
    contesta: CONTESTA.NOSOTROS,
    detalle: 'Se señala la otra venta; NO se le abre el faltante. Eso lo hace una persona.',
    escenarios: [
