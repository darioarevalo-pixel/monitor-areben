...
export const DESCRIPCIONES: Record<string, string> = {
  ...
  'meta-ads': 'La pauta de Meta en seis pantallas: qué hay que decidir, las campañas con sus acciones, en qué etapa del embudo está cada una, las ideas de creativos, los números por cuenta y el registro de lo accionado.',
