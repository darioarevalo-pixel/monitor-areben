...
export const DESCRIPCIONES: Record<string, string> = {
  ...
  'meta-ads': 'La pauta de Meta en nueve pantallas: qué hay que decidir, las campañas con sus acciones, la biblioteca de todos los avisos con su rendimiento, la carga de piezas nuevas, las automatizaciones que avisan solas, en qué etapa del embudo está cada una, las ideas de creativos, los números por cuenta, y el registro de lo accionado junto con las decisiones tomadas a mano y su motivo.',
