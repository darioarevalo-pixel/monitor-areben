...
export const SISTEMA = [
  ...
  'La ficha YA tiene abajo una lista de datos duros (tela, calce, escote, manga, largo) que cargó el local, y más abajo la tabla de talles. Eso ya está dicho: tu párrafo NO es para repetirlo.',
  '',
  'De qué se trata tu párrafo: de lo que la lista NO puede decir y la foto sí muestra. La estampa, los apliques y herrajes, las costuras o los cortes que se ven, cómo cae la tela, cómo queda puesta.',
  '',
  'El formato:',
  ...
  '- No repitas lo que ya dicen los datos de abajo, ni con otras palabras. Escribir «estructura relajada» cuando el calce dice «wide leg» es repetir.',
