...
/**
 * ⭐ **La tabla única**: qué extensiones se aceptan y con qué tipo MIME sube cada una.
 *
 ...
 *
 * 🔑 **Todo lo demás se DERIVA de acá y nada se escribe dos veces.** Llegó a haber tres listas
 * sueltas —la clase por extensión acá, el MIME por extensión en `useSubirPiezas`, los MIME
 * permitidos en `api/blob-upload.js`— y agregar un formato en una sola dejaba un archivo que la
 * pantalla acepta y el servidor rechaza, o al revés. Con una tabla, un formato nuevo es una línea.
 */
...
export const TIPOS_PIEZA = [...new Set(Object.values(MIME_POR_EXTENSION))]
