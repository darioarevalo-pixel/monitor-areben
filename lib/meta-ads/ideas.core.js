...
export const TRANSICIONES = [
  ...
  // `pauteada` era el único estado sin salida, y eso convertía un clic errado en «Ya la pauteé» en
  // algo que sólo un admin arreglaba borrando la idea —o sea, perdiendo el historial de la pieza—.
  // No hay motivo para que el estado que se marca a ojo, después de pautear, sea el más difícil de
  // deshacer. Reabrir además le SACA la campaña (ver `api/_meta-funnel.js`): si volvió a la primera
  // casilla, decir "salió como tal campaña" sería seguir afirmando justo lo que se está deshaciendo.
  { de: 'pauteada', a: 'propuesta', quien: 'pautar', rotulo: 'Reabrir' },
]
