...
export const ACCIONES = {
  ...
  duplicar: {
    // El sub `crear` cubre también la Tanda 3: cada sub son dos tildes manuales por persona y por
    // marca, y uno más es uno más que alguien se olvida de dar.
    sub: 'crear',
    rotulo: 'duplicar',
...
export function validarPedido(p) {
  ...
  return { ok: true, def, accion, nivel, objetoId, campos: objeto ? campos : {}, idem }
}
