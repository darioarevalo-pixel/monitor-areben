...
export function silencioDeReglas(reglas, ahora) {
  ...
  if (!corridas.length) {
    return {
      ...
      texto: `Hay ${cuantas} y todavía no corrió ninguna, así que este vacío ⛔ tampoco significa «está todo bien». Evalúan la foto del día cerrado a las 07:50; el primer hallazgo llega en la próxima corrida.`,
    }
  }
