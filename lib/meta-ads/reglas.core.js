 ...
 */
export function evaluarRegla(regla, { filas, umbralLinea, hasta, decisiones = null }) {
 ...
 */
export function calibrar(regla, { filas, umbralLinea, hasta, dias = 90, decisiones = null }) {
  ...
  const hoy = evaluarRegla(regla, { filas, umbralLinea, hasta, decisiones })
  ...
  for (const fecha of fechas.slice().reverse()) {
    ...
    const r = evaluarRegla(regla, { filas, umbralLinea, hasta: fecha, decisiones })
    if (!r.ok) return r
