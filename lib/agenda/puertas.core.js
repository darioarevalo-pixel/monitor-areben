 ...
 * | Compra nacional       | Administración      | Zattia: el local · BDI: Administración   |
...
export const PUERTAS = [
  ...
  },
  {
    ...
    ayuda: 'Flores. El nombre lo asigna Administración desde el banco de nombres. La descripción la escribe el local si es ropa de Zattia, y Administración si son fundas de BDI.',
  },
  {
    key: 'importacion',
    label: 'Importación',
...
/** ¿Es una de las cuatro? Se pregunta **una sola vez**, en la entrada de `sembrar`. */
