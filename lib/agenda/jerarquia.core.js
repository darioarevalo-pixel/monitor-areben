 ...
 * - `{tipo:'horas-extras'}` → **no**, y cae solo en el `return false` de abajo. Es a propósito y no
 *   es un olvido: quién hace horas extras es una condición laboral, no un lugar en el organigrama,
 *   y hasta un socio que las hiciera estaría cargando **las suyas**. Esconderle a Administración la
 *   rutina de fin de mes sólo la dejaría sin ver que a alguien le falta cargarlas.
 *
