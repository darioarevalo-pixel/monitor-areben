...
export const PLANTILLAS = [
  {
    ...
    pantalla: {
      ...
      vacio: 'Todavía no hay ningún paso cargado como molde. Se cargan una sola vez desde «Nuevo pendiente», tildando «Es un paso de la lista de ingreso» y poniéndole la dueña y a los cuántos días va. Después, cada ingreso los clona solo.',
    },
  ...
  },
  {
    ...
    ayuda: 'Los once renglones del manual «Cómo se lanza un producto» que NO comparte con el ingreso. El molde no corre ningún día: se clona cuando un lanzamiento queda firme en el calendario.',
    /**
  ...
  },
  {
    ...
    ayuda: 'Lo que hay que comunicar cuando cambia una promo, una forma de pago o el envío. El molde no corre ningún día: se clona cuando el cambio pasa.',
    /**
    ...
    pantalla: {
      ...
      */
      ...
      vacio: 'Todavía no hay ningún paso cargado como molde. Se cargan una sola vez desde «Nuevo pendiente», tildando «Es un paso de un cambio de condición comercial» y poniéndole la dueña y a los cuántos días va. Después, cada cambio los clona solo.',
    },
    /**
