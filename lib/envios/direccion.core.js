...
export function puntoDeGeoref(direccion) {
  ...
  return { lat, lng, altura, esquina, preciso: Boolean(altura || esquina), nomenclatura };
}
...
export function sugerenciaDePunto(resultado, zonas) {
  ...
  if (!punto.preciso) {
    return { estado: 'punto_impreciso', precio: null, zona: null, punto: null, encontrado: punto.nomenclatura };
  }
