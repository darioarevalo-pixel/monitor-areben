...
export function validarEnvio(e) {
  ...
  // `null` es "lo mismo que el envío" y es el caso normal; lo que no puede es ser basura o negativo.
  if (!montoValido(e.pago_cadete)) return 'Lo que cobra el cadete tiene que ser un número de cero para arriba.';
  return null;
}
