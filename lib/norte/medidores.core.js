...
/**
 * Los medidores, con su unidad pegada.
 *
 * 🔑 **`unidades-dia` y `ventas-dia` NO son el mismo número y por eso son dos medidores.** Una
 * compra puede llevar varias fundas: en BDI el mayorista hace 228 fundas/día en muy pocas compras,
 * y online hace 11,6 fundas/día en bastantes más. Un objetivo de «100 por día» cargado contra el
 * medidor equivocado da un avance plausible y falso, que es exactamente lo que este catálogo vino
 * a evitar.
 *
...
export const MEDIDORES = [
  ...
  },
  {
    ...
    unidad: 'ventas/día',
    necesitaPlata: false,
    hint: 'Cuántas compras entran por día. Ojo: no es lo mismo que fundas — una compra puede llevar varias.',
  },
  {
    key: 'contrib-unidad',
