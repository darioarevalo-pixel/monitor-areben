// Aplica sql/migrate-meta-favorito.sql a la base de BDI del monitor.
// Lee DATABASE_URL_BDI del .env.
// Uso: node scripts/apply-meta-favorito.mjs
//
...
const sql = readFileSync('sql/migrate-meta-favorito.sql', 'utf8')
const TABLAS = ['meta_ads_favorito']
