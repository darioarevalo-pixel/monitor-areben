// Aplica sql/migrate-meta-decision.sql a la base de BDI del monitor.
// Lee DATABASE_URL_BDI del .env.
// Uso: node scripts/apply-meta-decision.mjs
//
// ⚠️ Va a UNA SOLA base, igual que apply-meta-reglas.mjs y apply-meta-snapshot.mjs, y por el mismo
...
const sql = readFileSync('sql/migrate-meta-decision.sql', 'utf8')
const TABLAS = ['meta_ads_decision']
