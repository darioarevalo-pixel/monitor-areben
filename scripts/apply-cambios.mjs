...
const sql = ['sql/migrate-cambios.sql', 'sql/migrate-cambios-2.sql', 'sql/migrate-cambios-3.sql', 'sql/migrate-cambios-4.sql', 'sql/migrate-cambios-5.sql'].map((f) => readFileSync(f, 'utf8')).join('\n;\n')
