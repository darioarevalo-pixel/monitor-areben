// Aplica sql/migrate-meta-informe.sql a la base de BDI del monitor.
// Lee DATABASE_URL_BDI del .env.
// Uso: node scripts/apply-meta-informe.mjs
//
// ⚠️ Va a UNA SOLA base, igual que apply-meta-decision.mjs y apply-meta-reglas.mjs, y por el mismo
...
const sql = readFileSync('sql/migrate-meta-informe.sql', 'utf8')
const TABLAS = ['meta_ads_informe']
