...
| **Marketing · Tienda Nube › Categorías** (las dos cards: «Explorar una categoría» y «Asignar por Excel») | **selector** (7-sep-2026), mismo motivo: escriben `categories` en **una** tienda. Cambiar de línea **suelta la categoría y lo elegido** — son `id` de producto de la tienda que se estaba mirando |
